                                        ...
                                        <table class='table table-hover mails m-0 table table-actions-bar'>
                                            ...
                                            <tbody>";
                                              while($fila = mysqli_fetch_array($resultado))
                                              {
                                                  ...
                                                  $imagen_em = $fila['imagen'];
                                                  $nombre_em = $fila['nombre'];
                                                  $correo_em = $fila['correo'];
                                                  $telefono_em = $fila['telefono'];
                                                  $direccion_em = $fila['direccion'];
                                                  
                                                  echo" <tr>
                                                          <td>
                                                            <a href='visit_profile.php?nom=$nombre&tipo=$tipo_empleado&imagen=$foto&id_profile=$id_emp' class='text-muted'><img src='assets/images/users/$imagen_em' alt='contact-img' title='contact-img' class='img-circle thumb-sm' /></a>
                                                          </td>
                                                          <td>
                                                            $nombre_em
                                                          </td>
