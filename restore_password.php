                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 card-box">
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="POST" action="restore_new_password.php">
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                <label for="emailaddress">Nueva Contraseña</label>
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-xs-12">
                                                <label for="emailaddress">Confirmar Nueva Contraseña</label>
