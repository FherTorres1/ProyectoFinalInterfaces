                                ...
                                <div class="p-0 text-center">
                                    <div class="member-card">
                                        <div class="thumb-xl member-thumb m-b-10 center-block">
                                            <img src="assets/images/users/<?php echo $imagen_profile?>" class="img-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                                        </div>

                                        <div class="">
                                            <h4 class="m-b-5"><?php echo $nombre_profile?></h4>
                                            <p class="text-muted">@<?php echo $tipo_profile?></p>
                                        </div>

                                        <p class="text-muted m-t-10">
                                            ¡Hola!, soy <?php echo $nombre_profile?>, soy <?php echo $tipo_profile?> del café María Bonita y su sistema.
                                        </p>
