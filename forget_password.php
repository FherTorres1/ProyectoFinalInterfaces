                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 card-box">
                                <div class="text-center">
                                    <h2 class="text-uppercase m-t-0 m-b-30">
                                        <a href="pages-login.html" class="text-success">
                                ...
                                <div class="account-content">
                                    <div class="text-center m-b-20">
                                        <p class="text-muted m-b-0 line-h-24">Ingresar el correo electrónico y el usuario con el que te registraste para restrablecer tu contraseña. </p>
                                    </div>

                                    <form class="form-horizontal" method="POST" action="compare_password.php">
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted"><a href="index.php" class="text-dark m-l-5">Regresar</a></p>
                                </div>
                            </div>
